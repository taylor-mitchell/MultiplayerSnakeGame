...
public class Renderer
{
	 ...
	 * 
	 * @param rawQuad
	 *            RawQuad of the entity to render
	 */
	...
	public void renderEntities(List<Entity> entitiesToRender)
	{
		...
		// Assuming all body parts use the same RawQuad, we only need to bind it
		// once
		bindModel();
		...
		for (Entity entity : entitiesToRender)
		{
			...
			{
				// Assuming all body parts use the same texture, we only need to
				// bind it once
